...
- 레이지 로딩 등도 지원함
- 블러 효과로 사전에 흐린 이미지로 로딩 후 완료시 선명한 이미지로 대체
...
<Image src={경로} alt={설명} width={너비} height={높이} />;
```
...
export const generateMetadata = async ({
  ...
  return {
    title: `${keyword} 검색 페이지`,
    description: `${keyword} 검색 페이지입니다.`,
    openGraph: {
      title: `${keyword} 검색 페이지`,
      description: `${keyword} 검색 페이지입니다.`,
      images: [{ url: "/thumbnail.png" }],
